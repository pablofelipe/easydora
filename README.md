...
- [x] **Opened 2026-07-15, closed 2026-07-15.** No metric distinguished a
      ...
      `SimpleMeterRegistry` in that case.
- [x] **Opened 2026-07-17, closed 2026-07-17 (Architectural note).** Docker
      ...
      `kind` chosen over Minikube/k3d on technical grounds. Frontend
      explicitly out of scope, left for a separate, later delivery. Docker
      Compose remains the recommended environment for local development.
      See [ADR-0040](docs/adr/0040-minimal-kubernetes-kind-deployment.md).
