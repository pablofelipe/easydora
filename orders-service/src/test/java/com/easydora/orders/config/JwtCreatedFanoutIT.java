 ...
 * not round-robinned between them. This test talks to a real RabbitMQ (CI
 * Phase 2 service container) and drives the actual @Configuration bean
 * declarations in RabbitMQConfig, not a re-declared topology.
 */
