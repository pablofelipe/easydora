...
class RabbitMqProgressHealthIndicatorTest {
    ...
    void upWhileTheWatchdogIsNotStuck() {
        ...
        when(watchdog.isStuck(org.mockito.ArgumentMatchers.any(Duration.class))).thenReturn(false);
    ...
    void downOnceTheWatchdogReportsStuck() {
        ProgressWatchdog watchdog = mock(ProgressWatchdog.class);
        when(watchdog.isStuck(org.mockito.ArgumentMatchers.any(Duration.class))).thenReturn(true);
